 ...
 *  just resolves as a plain solid A, same as any fine detail would — not a
 *  legibility problem, just less flourish at that size. Source:
 *  ./svg/product.svg (edit there — this file just re-exports it). */
